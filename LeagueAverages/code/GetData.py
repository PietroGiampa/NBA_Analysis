...
path_exp = r'/Users/GiampaPietro/Desktop/NBA_Analysis/LeagueAverages/data//dataPL_{}.csv'.format(year)
export_csv = stats.to_csv (path_exp, index = None, header=True, sep='\t')
print('!!!!   DONE   !!!!')
